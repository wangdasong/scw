angular.module('controller.webpage.container.widget.button', [])
    .directive('widgetButton', ['DataService', 'Session', 'APP_CONFIG', function (DataService, Session) {
        var reloadScope = function (scope, element, attrs, data) {
            ...
            for(var index in data.attConfigs){
                ...
                if(currAttConfigType == "situation"){
                    var situation = currAttConfig.attValue;
                    scope.situation = situation;
                    if(situation == "pink"){
                        scope.situationDis = "btn-pink";
                    }else if(situation == "warning"){
                        scope.situationDis = "btn-warning";
                    }else if(situation == "danger"){
                        scope.situationDis = "btn-danger";
                    }else if(situation == "inverse"){
                        scope.situationDis = "btn-inverse";
                    }else if(situation == "purple"){
                        scope.situationDis = "btn-purple";
                    }else if(situation == "grey"){
                        scope.situationDis = "btn-grey";
                    }else if(situation == "yellow"){
                        scope.situationDis = "btn-yellow";
                    }else if(situation == "light"){
                        scope.situationDis = "btn-light";
                    }else if(situation == "white"){
                        scope.situationDis = "btn-white";
                    }else{
                        scope.situationDis = "btn-info";
                    }
                }
            ...
            if(output){
                ...
                scope.outputServiceName = outputServiceName;
            }
