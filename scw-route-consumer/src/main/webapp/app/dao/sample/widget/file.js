...
function WidgetFileSample(){
}

WidgetFileSample.prototype = {
    currWidget:null,
    createObject : function (containerId, widgetId) {
        ...
        this.currWidget.code = "FILE_SAMPLE";
        this.currWidget.name = "fileSample";
        this.currWidget.type = "file";
