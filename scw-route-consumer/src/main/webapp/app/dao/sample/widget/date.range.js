...
function WidgetDateRangeSample(){
}

WidgetDateRangeSample.prototype = {
    currWidget:null,
    createObject : function (containerId, widgetId) {
        ...
        this.currWidget.code = "SAMPLE_DATE_RANGE_WIDGET";
        this.currWidget.name = "sampleDateRange";
        this.currWidget.type = "daterangepicker";
        ...
        */
        ...
        attFormat.attValue = "YYYY-MM-DD HH:mm:ss";
        ...
        attType.attValue="datetimerangepicker";
