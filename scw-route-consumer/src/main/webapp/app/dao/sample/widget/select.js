...
function WidgetSelectSample(){
    currWidget = new Widget();
}

WidgetSelectSample.prototype = {
    createObject : function (containerId, widgetId) {
        ...
        this.currWidget.code = "SELECT_SAMPLE";
        this.currWidget.name = "sampleSelect";
        this.currWidget.type = "select";
