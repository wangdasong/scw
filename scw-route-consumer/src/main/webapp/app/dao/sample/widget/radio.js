...
function WidgetRadioSample(){
    currWidget = new Widget();
}

WidgetRadioSample.prototype = {
    createObject : function (containerId, widgetId) {
        ...
        this.currWidget.code = "RADIO_SAMPLE";
        this.currWidget.name = "sampleRadio";
        this.currWidget.type = "radio";
