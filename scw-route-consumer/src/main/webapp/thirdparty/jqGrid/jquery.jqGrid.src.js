...
//					var rindex = ptr[0].rowIndex;
//					var columnArray = $(ts).jqGrid('getGridParam','colModel');
//					var currEditable = columnArray[ci].editable;
//					if(currEditable){
//						try {$(ts).jqGrid("editCell",rindex,ci,true);} catch (_) {}
//					}
					ri = ptr[0].rowIndex;
